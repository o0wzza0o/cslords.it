...
export function Footer() {
  return (
    <footer suppressHydrationWarning className="border-t border-[var(--blue-border)]/30 bg-[var(--bg-primary)]/60 backdrop-blur-md py-8 px-6 text-xs text-[var(--text-secondary)]">
      <div suppressHydrationWarning className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4">
