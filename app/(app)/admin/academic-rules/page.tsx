        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div>
            <h1 className="text-2xl sm:text-3xl font-extrabold text-white tracking-wide flex items-center gap-2">
              <GraduationCap className="w-8 h-8 text-[var(--blue-glow)]" /> Academic <span className="glow-heading">Rules Engine</span>
            </h1>
            <p className="text-xs text-[var(--text-secondary)] mt-1">
              Map student ID email prefixes (e.g. 42510) to Academic Levels (e.g. Level 2 - Second Year).
            </p>
          </div>
